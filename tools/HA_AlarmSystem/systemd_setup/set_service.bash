...
function create_service() {
    local service_description="hAlarm hight availability and alarming service louncher"
    local exec_cmd="/bin/bash hAlarm.bash"
    local working_dir="/home/${rpitools_linux_user}/rpitools/tools/HA_AlarmSystem/"
    local syslog_idf="hAlarm"
