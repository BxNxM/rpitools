...
service_name="oled_gui_core.service"
...
function create_service() {
    local service_description="oled service 128x64"
    local exec_cmd="/usr/bin/python -u oled_gui_core.py"
    local working_dir="/home/${rpitools_linux_user}/rpitools/gpio/oled_128x64/lib/"
    local syslog_idf="oled_gui_core"
